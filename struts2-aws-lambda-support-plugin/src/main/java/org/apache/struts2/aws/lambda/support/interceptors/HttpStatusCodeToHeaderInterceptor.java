...
/**
 * Lambda can not handle the request status itself. Workarround is to set the status code as response header and read this afterwards in the {@link org.apache.struts2.aws.lambda.support.handler.Struts2LambdaContainerHandler} to set correct status code.
 */
@Log4j2
