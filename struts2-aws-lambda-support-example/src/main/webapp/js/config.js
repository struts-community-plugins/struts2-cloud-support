...
(function() {
    ...
    angular
    .module('app')
        .config(['$routeProvider', '$locationProvider', '$translateProvider', 'apiEndpoint',
            function($routeProvider, $locationProvider, $translateProvider, apiEndpoint) {

                // Configuration for translation provider
                $translateProvider.registerAvailableLanguageKeys(['en', 'de']);
                $translateProvider.fallbackLanguage('en');
                $translateProvider.useUrlLoader(apiEndpoint + '/data/language', {
                    queryParameter: 'request_only_locale'
                });
